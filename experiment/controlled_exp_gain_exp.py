...
def rectify_image(frame, params, last_rvec, last_tvec, calib_w, calib_h, mtx, dist):
    ...
    if not np.all(ids is not None):
        rvec = last_rvec
        tvec = last_tvec
        # print("No markers found -> last known pose used")
        ...
        if not retval:
            rvec = last_rvec
            tvec = last_tvec
            # print("No pose estimated -> last known pose used")
    
    if rvec is None or tvec is None:
        # print("Pose has never been estimated yet")
        return None, last_rvec, last_tvec
    ...
    return rectified_frame, rvec, tvec
...
def main():
    ...
    result_filename = calib_file + "_" + distance + "_" + "_" + h_angle + "_" + v_angle + "_gain_exp.json"
    result_filepath = "experiment/exp_results/special/gain_exp/" + result_filename
    ...
    while True:
        ...
        rectified_frame, rvec, tvec = rectify_image(frame, params, rvec, tvec, calib_w, calib_h, mtx, dist)
    ...
    for exposure in [100, 250, 500]:
        ...
        for gain in [5, 10, 15]:
            ...
            for image in images:
                ...
                print(f"Image {img_code}, Exp {exposure}, Gain {gain}")
